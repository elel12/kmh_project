...
<form class="signUp" id="signupForm" METHOD=POST ACTION="loginProc.jsp">
   <h1 class="signUpTitle">로 그 인 ( L o g i n )</h1>
   <input type="text" NAME="id" class="signUpInput" onKeyPress="return numkeyCheck(event)" placeholder="학생 : 학번 / 교직원 : 교직원번호">
   <input type="password" NAME="pw" class="signUpInput" placeholder="비밀번호를 입력하세요.">
   초기비밀번호는 생년월일입니다.&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<a href="javascript:popupOpen();">비밀번호 찾기</a>
   <input type="button" onClick="javascript:CheckForm(signupForm)" value="로  그  인" class="signUpButton">
</form>
