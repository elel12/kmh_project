	...
	<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	  ...
	  <!-- 
		...
		<div id="fh5co-page">
			...
			<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
				...
				<nav id="fh5co-main-menu" role="navigation">
					<ul>
						...
						<li class="fh5co-active"><a href="manager_pro_profile.jsp">교직원계정</a></li>
						<FONT style="color:black;font-weight: bold;font-size: 1.5em;">강의</FONT>
						<li><a href="manager_lecture.jsp">강의개설</a></li>
					</ul>
				</nav>
			...
			<div id="fh5co-main">
	<br><br>
				<iframe width="100%" height="675" src="pro_list.jsp" name="main_stu" id="main_stu" scrolling="no" frameborder="0">이 브라우저는 iFram을 원합ㅈ멜'</iframe>
