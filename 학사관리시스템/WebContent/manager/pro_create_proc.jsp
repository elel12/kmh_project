...
<%
	...
	try{
		...
		pstmt.setInt(3,pro_sex);
		pstmt.setString(4,pro_address);
		pstmt.setInt(5,pro_birth);
		pstmt.setString(6,pro_mail);
		pstmt.setString(7,pro_phone);
		pstmt.setString(8,pro_office);
		pstmt.setString(9,pro_pw);
		pstmt.setInt(10,major_major_code);
