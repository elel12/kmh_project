...
<%
	...
	try{
		...
		pstmt.setInt(1,major_major_code);
...
<FORM NAME="modify" METHOD=POST ACTION="profileproc.jsp">
...
<TABLE WIDTH=100%>
	...
	<TR>
		<TD ALIGN=LEFT><B>학번&nbsp&nbsp&nbsp<INPUT TYPE=TEXT NAME="stu_code" SIZE=10 style = "text-align:center;" value=<%=stu_code%> readonly></B></TD>
		<TD ALIGN=LEFT><B>이름&nbsp&nbsp&nbsp<INPUT TYPE=TEXT NAME="stu_name" SIZE=10 style = "text-align:center;" value=<%=stu_name%>></B></TD>
		<TD ALIGN=LEFT><B>전공&nbsp&nbsp&nbsp<INPUT TYPE=TEXT NAME="major_major_code" SIZE=15 style = "text-align:center;" value=<%=major_name%> readonly></B></TD>
		<TD ALIGN=LEFT><B>지도교수&nbsp&nbsp&nbsp<INPUT TYPE=TEXT NAME="professor_pro_code" SIZE=10 style = "text-align:center;" value=<%=pro_name%> readonly></B></TD>
	</TR>
	<TR></TR><TR></TR><TR></TR><TR></TR><TR></TR>
	<TR>
		<TD ALIGN=LEFT><B>생일&nbsp&nbsp&nbsp<INPUT TYPE=TEXT NAME="stu_birth" SIZE=10 style = "text-align:center;" value=<%=stu_birth%> readonly></B></TD>
		<TD ALIGN=LEFT><B>성별&nbsp&nbsp&nbsp<INPUT TYPE=TEXT NAME="stu_sex" SIZE=5 style = "text-align:center;" value=<%=stu_sex%>></B></TD>
		<TD ALIGN=LEFT><B>상태&nbsp&nbsp&nbsp<INPUT TYPE=TEXT NAME="stu_condition" SIZE=5 style = "text-align:center;" value=<%=stu_condition%> readonly></B></TD>
		<TD ALIGN=LEFT><B>학년&nbsp&nbsp&nbsp<INPUT TYPE=TEXT NAME="stu_level" SIZE=5 style = "text-align:center;" value=<%=stu_level%> readonly></B></TD>
	</TR>
	<TR></TR><TR></TR><TR></TR><TR></TR><TR></TR>
	<TR>
