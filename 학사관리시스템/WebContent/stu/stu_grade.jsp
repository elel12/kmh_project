	...
	<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	  ...
	  <!-- 
		...
		<div id="fh5co-page">
			...
			<aside id="fh5co-aside" role="complementary" class="border js-fullheight">
				...
				<nav id="fh5co-main-menu" role="navigation">
					<ul>
						...
						<li class="fh5co-active"><a href="stu_grade.jsp">성적조회</a></li>
			...
			<div id="fh5co-main">
	<br><br>
				<iframe width="100%" height="675" src="grade.jsp" name="main_stu" id="main_stu" scrolling="yes" frameborder="0">이 브라우저는 iFram을 원합ㅈ멜'</iframe>
